...
public class DonationHandler implements Runnable {
    ...
    private static final String USER = "Special-PKzps_master";
    private static final String PASS = "Special-PKzfromashes317*";
    private static final String DATABASE = "Special-PKzps_donation";
