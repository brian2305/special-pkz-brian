...
public class ItemAssistant {
	...
	public void sendWeapon(int Weapon, String WeaponName) {
		...
		} else if (WeaponName2.startsWith("halberd") || WeaponName2.startsWith("scythe")) {
	...
	public boolean is2handed(String itemName, int itemId) {
		...
		if (itemName.contains("godsword") || itemName.contains("crystal") || itemName.contains("aradomin sword")
				...
				itemName.contains("clueless") || itemName.contains("ballista") || itemName.contains("hunting knife") || itemName.contains("elder maul") || itemName.contains("bulwark") || itemName.contains("claws") || itemName.contains("scythe")) {
			return true;
		}
		switch (itemId) {
		case 12926:
