    ...
    public enum Achievement {
      ...
      Bby_Dragon_Hunter_I(2, AchievementTier.TIER_1, AchievementType.SLAY_BABY_DRAGONS, null, "Kill 50 Baby Dragons", 50, 1, new GameItem(995, 50000), new GameItem(535, 100), new GameItem(405)),
       ...
       Fishing_Task_I(6, AchievementTier.TIER_1, AchievementType.FISH, null, "Catch 1000 Fish", 1000, 1, new GameItem(995, 50000), new GameItem(384, 50)),
        ...
        Kills_10_Players(23, AchievementTier.TIER_1, AchievementType.KILLS_10_PLAYERS, null, "Kill 10 Players.", 10, 1, new GameItem(2996, 20), new GameItem(10551), new GameItem(13307, 3000)),
        /**
        ...
        KILLS_50_PLAYERS(21, AchievementTier.TIER_2, AchievementType.KILLS_50_PLAYERS, null, "Kill 50 Players", 50, 2, new GameItem(4151), new GameItem(12848), new GameItem(13307, 8000)),
        KILLS_100_PLAYERS(21, AchievementTier.TIER_3, AchievementType.KILLS_100_PLAYERS, null, "Kill 100 Players", 100, 3, new GameItem(21003), new GameItem(19553), new GameItem(13307, 15000)),
        KILLS_500_PLAYERS(22, AchievementTier.TIER_3, AchievementType.KILLS_500_PLAYERS, null, "Kill 500 Players", 500, 3, new GameItem(13319), new GameItem(19481), new GameItem(13307, 500000)),
