...
public class TeleportHandler {
	...
	String[] monsterNames = { "Select your Monster Teleport", "Rock Crabs", "Cows", "Yaks", "Bob's Island",
			"Desert Bandits", "Elf Warriors", "Dagannoths", "Mithril Dragons", "Slayer Tower [Grotesque Guardians]", "Demonic Gorillas",
			"Taverley Dungeon", "Stronghold Cave", "Smoke Devils", "The Inadequacy", "Vespula", "", "", "", "", "" };
	String[] minigameNames = { "Select your Minigame Teleport", "Raids", "Warriors Guild", "Pest Control",
			"Fight Caves", "Barrows", "Clan Wars", "Danger Assault", "Mage Arena", "Duel Arena", "Raids 2 [Under Construction]", "", "", "", "",
			"", "", "", "", "", "" };
	String[] bossNames = { "Select your Boss Teleport", "Barrelchest", "Dagannoth Kings",
			"King Black Dragon@red@ (DANGEROUS!)", "Giant Mole", "Kalphite Queen", "God Wars Dungeon",
			"Corporeal Beast", "Dagannoth Mother", "Kraken", "Zulrah [Enter at own Risk]", "Cerberus", "Thermonuclear Smoke Devils",
			"Abyssal Sire", "Demonic Gorillas", "Lizardman Shaman", "Vorkath", "Giant Scarab", "", "", "" };
	...
	public void handleTeleports(Player player, int Id) {
		...
		case 180191:
			...
			if (player.teleSelected == 0) { // Monsters - Bob's Island
				...
				player.getPA().startTeleport(1771, 5168, 0, "modern", false);
		...
		case 180200:
			...
			} else if (player.teleSelected == 1) { // Minigames - Danger Assault
		...
		case 180221:
			...
			player.getPA().startTeleport(1823, 5166, 2, "modern", false);
			player.sendMessage("Welcome to the Inadequacy.");
		   break;
		case 180224:
			if (player.teleSelected == 2) {
				player.getPA().startTeleport(1558, 3696, 0, "modern", false);
			}
			player.getPA().startTeleport(3276, 2785, 0, "modern", false);
			player.sendMessage("Welcome to Vespula and his soldiers.");
			break;
		case 180239://Giant Scarab
				player.getPA().startTeleport(2916, 3625, 0, "modern", false);
				player.sendMessage("Welcome to the Giant Scarab.");
			break;
		case 180240://the Inadequacy
			player.getPA().startTeleport(1823, 5166, 2, "modern", false);
			player.sendMessage("Welcome to the Inadequacy.");
		break;
		case 180227: //vorkath
