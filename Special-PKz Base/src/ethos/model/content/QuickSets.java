...
public class QuickSets {
	...
	public enum QUICKSETS {
		MELEE_ZERKER(0, 
				new int[][] { { 3751, 1 }, { 6568, 1 }, { 1704, 1 }, { 4587, 1 }, { 10551, 1 }, { 8850, 1 }, { -1, -1 }, { 1079, 1 }, { -1, -1 }, { 7460, 1 }, { 4131, 1 }, { -1, -1 }, { 2550, 1 }, { -1, -1 } }, 
		...
		BRID_MAIN(2, 
				...
				new int[][] { { 1333, 1 }, { 4587, 1 }, { 3040, 1 }, { 2440, 1 }, { 3024, 2 }, { 6685, 3 }, { 2503, 1 }, { 1079, 1 }, { 11936, 14 }, { 555, 1000 }, { 560, 1000 }, { 565, 1000 } }),
	
		MELEE_PURE(3, 
				new int[][] { { 740, 1 }, { 6568, 1 }, { 1704, 1 }, { 4587, 1 }, { 6107, 1 }, { 3842, 1 }, { -1, -1 }, { 6108, 1 }, { -1, -1 }, { 7458, 1 }, { 3105, 1 }, { -1, -1 }, { 2550, 1 }, { -1, -1 } }, 
		...
		BRID_PURE(5, 
				...
				new int[][] { { 5698, 1 }, { 4587, 1 }, { 2440, 1 }, { 3040, 1 }, { 3024, 2 }, { 6685, 3 }, { 11936, 16 }, { 555, 1000 }, { 560, 1000 }, { 565, 1000 } }),
	...
	public static void gearUp(final Player player, int setId) {
		for (QUICKSETS set : QUICKSETS.values()) {
			...
			if (setId == set.id) {
				...
				case 1:
					for (int i = 0; i < 7; i++) {
						player.playerLevel[i] = 80;
						player.playerXP[i] = player.getPA().getXPForLevel(80) + 1;
				...
				case 4:
				case 5:
					player.playerLevel[0] = 70;
					player.playerLevel[1] = 1;
					player.playerLevel[2] = 70;
					player.playerLevel[3] = 70;
					player.playerLevel[4] = 70;
					player.playerLevel[5] = 52;
					player.playerXP[0] = player.getPA().getXPForLevel(70) + 1;
					player.playerXP[1] = 0;
					player.playerXP[2] = player.getPA().getXPForLevel(70) + 1;
					player.playerXP[3] = player.getPA().getXPForLevel(70) + 1;
					player.playerXP[4] = player.getPA().getXPForLevel(70) + 1;
