...
public class DialogueHandler {
	...
	public void sendDialogues(int dialogue, int npcId) {
		...
		case 55864:
			sendNpcChat2("Welcome to the Danger House!", "Home of the best soldiers in the entire WORLD!",
					c.talkingNpc, "Danger Guard");
			c.nextChat = 0;
			break;
		case 55865:
		...
		case 5998:
			sendNpcChat3("Only <img=4>@red@Donators @bla@can access the Donator Zone.",
					"Interested in becoming an Special-PKz <img=4>@red@Donator@bla@?",
		...
		case 55867:
			sendNpcChat2("I've heard rumors about wilderness skilling.",
					"I haven't ventured far enough north to find it.", c.talkingNpc, "Danger Guard");
			c.nextChat = 0;
			break;
		...
		case 55872:
			...
			break;
		case 55873:
			sendNpcChat2("Hello, my name is Banky.", "I was hired by Special-PKz to be a travelling banker!", c.talkingNpc,
					"Banky The Banker");
			c.nextChat = 0;
			break;
		case 55875:
		...
		case 14012:
			sendPlayerChat3("Yeah! I've never seen one before.", "I guess it's one small step for NPC's,",
					"one giant leap for Special-PKz!");
			c.nextChat = 14013;
			break;
		case 14013:
		...
		case 673:
			sendNpcChat("Glad to see you have joined Special-PKz!", "To start, this is our lovely home area.",
					"Let me show you around!");
			c.nextChat = 674;
			break;

		case 674:
			c.getPA().movePlayer(3276, 3499, 0);
		...
		case 676:
			c.getPA().movePlayer(3284, 3505, 0);
			sendNpcChat("Slayer masters are located here.", "If you would like to do Wilderness Slayer",
					"Head to Edgville and talk to Krystillia!");
			c.nextChat = 677;
			break;

		case 677:
			c.getPA().movePlayer(3281, 3512, 0);
		...
		case 678:
			c.getPA().movePlayer(3285, 3509, 0);
		...
		case 679:
			c.getPA().movePlayer(3280, 3494, 0);
		...
		case 712:
			sendNpcChat("To teleport through the world simply click the magnify glass",
					"Click the teleport option, in the quick links section.", "that displays the catergory of teleports",
					"that will be shown in the interface.");
			c.nextChat = 710;
			break;

		case 713:
			sendNpcChat("Yes, you must follow rules of this world.", "Make sure you are aware of them! You can",
					"find and read them by visiting our website");
			c.nextChat = 710;
			break;
		...
		case 715:
			sendNpcChat("If you have been lucky enough to get your hands on",
					...
					"them into points by using the Exchange Handler right", "inside our home!");
			c.nextChat = 710;
			break;
		case 1577:
			...
			break;
		/*
		 * Teleports Reworked by C.T Makes it easier to add new ones. Better
		 * organization
		 */
		case 400:
		...
		case 403:
			sendOption5("Duel Arena", "Danger Assault", "Barrows", "", "");
			c.teleAction = 201;
			break;
