...
public class ItemOptionTwo implements PacketType {
	...
	public void processPacket(Player player, int packetType, int packetSize) {
		...
		case 22114://mystic cape teleport
			player.getPA().startTeleport(2457, 2859, 0, "modern", false);
			player.sendMessage("You have been teleported to the legendary donation zone.");
			break;
