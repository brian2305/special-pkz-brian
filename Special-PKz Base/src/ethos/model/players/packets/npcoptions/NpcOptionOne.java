...
case 4625:
	...
	player.sendMessage("@blu@ Please visit our website to Donate 1 = Trading Stick is 1$. ");
	player.sendMessage("@blu@Anything above 50$ at once will have a chance to receive a Ultra Mystery Box!");
	player.sendMessage("@blu@Contact C.T for more Details if need be.");
	break;
		case 7690:
		...
		case 276:
			if (Config.BONUS_XP_WOGW) {
				...
				player.getDH().sendNpcChat1("Well of Goodwill is currently @red@inactive@bla@!", 276, "Special-PKz Crier");
			}
			break;
		case 5520:
		...
		case 3220:
			...
			break;
		case 7633://donation store
			player.getShops().openShop(9);
			player.sendMessage("Please visit our website to Donate 1 Trading Stick is 1$. ");
			player.sendMessage("Anything above 50$ at once will have a chance to receive a Ultra Mystery Box!");
			player.sendMessage("Contact C.T for more Details if need be.");
			break;
		case 637:
