...
public class MonsterHunt {
	...
	public enum Npcs {
		...
		GLOD(5129, "Glod", 1500, 75, 350, 350),
		ICE_QUEEN(4922, "Ice Queen", 1500, 55, 350, 150),
		VESPULA(7531, "Vespula", 2000, 85, 350, 400);
		//GIANTSCARAB(1127, "Giant Scarab", 1400, 75, 350, 300),
		//MUTTADILE(7562, "Muttadile", 1200, 60, 350, 200);
	...
	public static void spawnNPC() {
		...
		}, 5000); //3000//was5000 THIS NUMBER HANDLES HOW OFTEN THE NEW NPC IS SPAWNED AND THE OLD ONE IS KILLED (IN TICKS)
